...
const NoticeCard: React.FC<NoticeCardProps> = ({ notice }) => {
  ...
  const formatDateTime = (dateString: string) => {
    ...
    const formattedDate = date.toLocaleDateString('en-GB').replace(/\//g, '/').slice(0, 8) // dd/mm/yy format
  ...
  return (
    <>
      <Card 
        ...
        sx={{
          width: { xs: '100%', sm: '100%', md: '400px', lg: '380px', xl: '360px' },
          maxWidth: '400px',
      ...
      >
        ...
        <Box
          sx={{
            ...
            height: 60,
            borderRadius: '50%',
            background: `conic-gradient(from 0deg, ${getTypeColor(notice.type).bg}, transparent)`,
            opacity: isHovered ? 0.4 : 0,
            transform: isHovered ? 'rotate(180deg) scale(1.5)' : 'rotate(0deg) scale(1)',
            ...
            <Box sx={{ mb: 2.5, display: 'flex', justifyContent: 'flex-start' }}>
              <Chip 
                ...
                sx={{
                  ...
                  height: 30,
                  borderRadius: 2.5,
                  boxShadow: `0 3px 10px ${getSubjectColor(notice.subject).shadow}`,
                  transform: isHovered ? 'scale(1.05)' : 'scale(1)',
                  transition: 'transform 0.3s ease',
                  '& .MuiChip-label': {
                    px: 2
              ...
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1.5, mt: 2 }}>
                ...
                <Chip 
                  ...
                  sx={{
                    ...
                    fontWeight: 600,
                    height: 32,
                    boxShadow: `0 4px 12px ${getSubjectColor(notice.subject).shadow}`,
                  }}
                />
              </Box>
            </Box>
        ...
        <DialogContent sx={{ pt: 3 }}>
          <Box sx={{ mb: 3 }}>
            ...
            >
              ...
              <Box sx={{ mx: 1, width: 6, height: 6, borderRadius: '50%', bgcolor: '#cbd5e1' }} />
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                {notice.title.length > 90 ? notice.title.substring(0, 90) + '...' : notice.title}
              </Typography>
            </Box>
